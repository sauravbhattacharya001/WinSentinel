...
public static partial class ConsoleFormatter
{
    ...
    public static void PrintHelp()
    {
        ...
        Console.ForegroundColor = ConsoleColor.White;
        Console.Write("    --age-days <n>       ");
        Console.ForegroundColor = original;
        Console.WriteLine("Finding age lookback period in days (default: 90)");
        Console.ForegroundColor = ConsoleColor.White;
        Console.Write("    --age-severity <s>   ");
        Console.ForegroundColor = original;
        Console.WriteLine("Filter age report by severity (critical/warning/info)");
        Console.ForegroundColor = ConsoleColor.White;
        Console.Write("    --age-module <m>     ");
        Console.ForegroundColor = original;
        Console.WriteLine("Filter age report by module name");
        Console.ForegroundColor = ConsoleColor.White;
        Console.Write("    --age-class <c>      ");
        Console.ForegroundColor = original;
        Console.WriteLine("Filter by classification (chronic/recurring/new/intermittent)");
        Console.ForegroundColor = ConsoleColor.White;
        Console.Write("    --age-top <n>        ");
        Console.ForegroundColor = original;
        Console.WriteLine("Number of findings to show (default: 10)");
        Console.WriteLine();
        ...
        Console.WriteLine("    winsentinel --age                                   # Full finding age report");
        Console.WriteLine("    winsentinel --age priority                           # Priority queue (fix first)");
        Console.WriteLine("    winsentinel --age chronic                            # Show chronic findings");
        Console.WriteLine("    winsentinel --age new                                # Show new findings");
        Console.WriteLine("    winsentinel --age resolved                           # Show resolved findings");
        Console.WriteLine("    winsentinel --age --age-severity critical            # Critical findings only");
        Console.WriteLine("    winsentinel --age --age-module firewall              # Filter by module");
        Console.WriteLine("    winsentinel --age --age-days 7 --json               # Last 7 days as JSON");
        Console.ForegroundColor = original;
        Console.WriteLine();
