...
public static class AttackSurfaceReductionAnalyzer
{
    ...
    public static readonly IReadOnlyList<AsrRule> RecommendedRules = new[]
    {
        ...
        new AsrRule("c0033c00-d16d-4114-a5a0-dc9b3a7d2ceb", "Block use of copied or impersonated system tools"),
        ...
        new AsrRule("33ddedf1-c6e0-47cb-833e-de6133960387", "Block rebooting machine in Safe Mode"),
